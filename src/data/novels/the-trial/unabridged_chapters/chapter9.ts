...
export const chapter9: Chapter = {
  ...
  "scenes": [
    ...
    },
    {
      ...
      "dialogue": [
        {
          "text": "\"According to the story, there are two important things that the doorkeeper explains about access to the law, one at the beginning, one at the end. At one place he says he can't allow him in now, and at the other he says this entrance was intended for him alone. If one of the statements contradicted the other you would be right and the doorkeeper would have cheated the man from the country. But there is no contradiction. On the contrary, the first statement even hints at the second. You could almost say the doorkeeper went beyond his duty in that he offered the man some prospect of being admitted in the future. Throughout the story, his duty seems to have been merely to turn the man away, and there are many commentators who are surprised that the doorkeeper offered this hint at all, as he seems to love exactitude and keeps strict guard over his position. "
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "dialogue": [
        {
          "text": "That means the doorkeeper will have to wait a long time before his function is fulfilled, he will have to wait for as long as the man liked, who came to the door of his own free will. Even the end of the doorkeeper's service is determined by when the man's life ends, so the doorkeeper remains his subordinate right to the end. And it's pointed out repeatedly that the doorkeeper seems to know nothing of any of this, although this is not seen as anything remarkable, as those who hold this view see the doorkeeper as deluded in a way that's far worse, a way that's to do with his service. At the end, speaking about the entrance he says, 'Now I'll go and close it,' although at the beginning of the story it says the door to the law is open as it always is, but if it's always open--always--that means it's open independently of the lifespan of the man it's intended for, and not even the doorkeeper will be able to close it. "
        }
      ]
    },
    {
      ...
      "dialogue": [
        {
          "text": "There are various opinions about this, some say the doorkeeper was only answering a question or showing his devotion to duty or, just when the man was in his last moments, the doorkeeper wanted to cause him regret and sorrow. There are many who agree that he wouldn't be able to close the door. They even believe, at the end at least, the doorkeeper is aware, deep down, that he's the man's subordinate, as the man sees the light that shines out of the entry to the law whereas the doorkeeper would probably have his back to it and says nothing at all to show there's been any change.\" \"That is well substantiated,\" said K., who had been repeating some parts of the priest's explanation to himself in a whisper. \"It is well substantiated, and now I too think the doorkeeper must have been deceived. Although that does not mean I've abandoned what I thought earlier as the two versions are, to some extent, not incompatible. It's not clear whether the doorkeeper sees clearly or is deceived. "
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "dialogue": [
        {
          "text": "It accepts you when you come and it lets you go when you leave.\""
        }
      ]
    }
  ]
