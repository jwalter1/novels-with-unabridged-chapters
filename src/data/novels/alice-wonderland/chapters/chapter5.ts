...
export const chapter5: Chapter = {
  ...
  "scenes": [
    ...
    {
      "id": "alice-un-c5-s2",
      "title": "Advice from a Caterpillar (Part 2)",
      "background": "default",
      "dialogue": [
        {
    ...
    {
      "id": "alice-un-c5-s3",
      "title": "Advice from a Caterpillar (Part 3)",
      "background": "default",
      "dialogue": [
        {
    ...
    {
      "id": "alice-un-c5-s4",
      "title": "Advice from a Caterpillar (Part 4)",
      "background": "default",
      "dialogue": [
        {
        ...
        {
          "text": "“What can all that green stuff be?” said Alice. “And where have my shoulders got to? And oh, my poor hands, how is it I can’t see you?” She was moving them about as she spoke, but no result seemed to follow, except a little shaking among the distant green leaves.",
          "characterId": "alice"
        },
        {
    ...
    {
      "id": "alice-un-c5-s5",
      "title": "Advice from a Caterpillar (Part 5)",
      "background": "default",
      "dialogue": [
        {
        ...
        {
          "text": "This was such a new idea to Alice, that she was quite silent for a minute or two, which gave the Pigeon the opportunity of adding, “You’re looking for eggs, I know that well enough; and what does it matter to me whether you’re a little girl or a serpent?”",
          "characterId": "alice"
        }
      ]
    },
    {
      "id": "alice-un-c5-s6",
      "title": "Advice from a Caterpillar (Part 6)",
      "background": "default",
      "dialogue": [
        {
